...
import { useAssetFindFirst, useRoqClient } from 'lib/roq';
...
function AssetViewPage() {
  ...
  const { data, error, isLoading } = useAssetFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('asset', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/assets/edit/${id}`} passHref legacyBehavior>
                    <Button
