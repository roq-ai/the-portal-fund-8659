...
import { useBalanceFindFirst, useRoqClient } from 'lib/roq';

import { BalanceInterface } from 'interfaces/balance';

function BalanceViewPage() {
  ...
  const { data, error, isLoading } = useBalanceFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('balance', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/balances/edit/${id}`} passHref legacyBehavior>
                    <Button
