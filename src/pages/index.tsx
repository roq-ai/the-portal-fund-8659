  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to The Portal Fund - Your one-stop dashboard for collecting, storing, and showcasing wallet addresses with asset balances and price performance. A new era in asset management."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1551288049-bebda4e38f71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXNoYm9hcmR8ZW58MHx8fHwxNjk5ODE1OTM2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to The Portal Fund - Your one-stop dashboard for collecting, storing, and showcasing wallet addresses with asset balances and price performance. A new era in asset management.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Analyst" type="analyst" abilities={appConfig.ownerAbilities} />
