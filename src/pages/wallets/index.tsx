...
import { useRoqClient, useWalletFindManyWithCount } from 'lib/roq';
...
export function WalletListPage(props: WalletListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useWalletFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.wallet.delete({ where: { id } });
      await mutate();
    } catch (error) {
