...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Assets', path: '/assets', entity: 'asset', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Balances', path: '/balances', entity: 'balance', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    {
      name: 'Price Performances',
      path: '/price-performances',
    ...
    { name: 'Wallets', path: '/wallets', entity: 'wallet', service: AccessServiceEnum.PROJECT, icon: FiCreditCard },
